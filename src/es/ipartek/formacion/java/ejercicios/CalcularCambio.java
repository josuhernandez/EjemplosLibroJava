 ...
 * La compra será de un valor de 1.326,24€ y se paga con cuatro billetes de 500€.<br>
 * 
 */
	...
	*/	
		...
		for (int i=0; i<BILLETES_MONEDAS.length; i++){
			...
			if (i>=0 && i<=3){
				...
				System.out.println(vuelta[i] + " Monedas de " + (int) (BILLETES_MONEDAS[i]*100) + " céntimos de Euro" );
			}
